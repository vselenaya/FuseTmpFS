...
2) Далее необходимо запустить код, указав папку, куда монтровать файлову систему. Также можно указать ключи.
Пример запуска:
```bash
./tm —d mnt
```
